/*{
	...
	"CREDIT": "by IMIMOT - ported from https://www.shadertoy.com/view/lsXSDn",
	"CATEGORIES": [
		"Stylize"
	],
	"INPUTS": [
...
void main()	{
	...
	result = result * length(IMG_NORM_PIXEL(inputImage,uv).rgb) + 0.22 * vec4(0.,IMG_NORM_PIXEL(inputImage,uv).g,0.,1.);
	if(result.b < 0.5)
